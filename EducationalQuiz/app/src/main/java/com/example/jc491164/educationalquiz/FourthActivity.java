...
public class FourthActivity extends AppCompatActivity {
    ...
    private final int NO_OF_PIECES = 16;
    DBHelper dbHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(bundle.getString("selectedImage").equals("c"))
            imageName = "c";
        else if(bundle.getString("selectedImage").equals("cc"))
            imageName = "cc";
        else if(bundle.getString("selectedImage").equals("ccc"))
            imageName = "ccc";
    ...
    private void test_db(){
        ...
        dbHelper.insertPlayer(name, time, 3,imageName);
